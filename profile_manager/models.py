...
class BaseUser(models.Model):
    ...
    connections = models.ManyToManyField('self', symmetrical=False, related_name='users', null=True, blank=True)
...
#     phone_numbers = models.IntegerField(max_length=30)
#     associates = models.ManyToManyField(BaseUser, symmetrical=False, related_name='institution', null=True, blank=True)
#     association_requests = models.ManyToManyField(BaseUser, symmetrical=False, related_name='institution', null=True, blank=True)
...
#     research_projects = models.ManyToManyField(ResearchProject, symmetrical=False, related_name='institution', null=True, blank=True)
#     active_courses = models.ManyToManyField(Course, symmetrical=False, related_name='institution', null=True, blank=True)
#     inactive_courses = models.ManyToManyField(Course, symmetrical=False, related_name='institution', null=True, blank=True)
#     offers = models.ManyToManyField(Course, symmetrical=False, related_name='institution', null=True, blank=True)
#
#
